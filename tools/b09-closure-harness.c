...
int main(int argc, char **argv) {
  ...
  /* Each invocation allocates two shared cells and three materialized closure environments.
     Top-level declarations now carry their actual function identities and need no module-facade
     objects. Ten across both calls distinguishes the native environment ABI from cell-only
     lowering. */
