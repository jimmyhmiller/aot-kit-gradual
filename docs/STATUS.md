...
ternaries, short-circuit operators and optional calls with known targets; function declarations, function expressions and block/expression-bodied arrows, default parameters, closures with
